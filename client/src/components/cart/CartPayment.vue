<template>
  <v-container>
    ...
    <v-col cols="12" sm="4" md="6" v-if="final !== 0">
        <v-btn block rounded="sm" size="x-large" @click="selectPaymentMethod('kakaopay')" :style="{ backgroundColor: selectedPaymentMethod === 'kakaopay' ? 'yellow' : 'gray' }">
    ...
    <v-col cols="12" sm="4" md="6" v-if="final !== 0">
        <v-btn block rounded="sm" size="x-large" @click="selectPaymentMethod('toss')" :style="{ backgroundColor: selectedPaymentMethod === 'toss' ? 'dodgerblue' : 'gray' }">
